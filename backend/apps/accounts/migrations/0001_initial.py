    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(help_text='فرمت: 09xxxxxxxxx', max_length=11, unique=True, validators=[apps.accounts.models.validate_iranian_phone], verbose_name='شماره موبایل')),
